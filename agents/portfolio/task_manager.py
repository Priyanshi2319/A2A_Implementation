...
# =============================================================================
# 🎯 Purpose:
# This file connects your Gemini-powered agent (PortfolioAgent) to the task-handling system.
...
# 🤖 Import the actual agent we're using (Gemini-powered PortfolioAgent)
...
class AgentTaskManager(InMemoryTaskManager):
    ...
    def __init__(self, agent: PortfolioAgent):
